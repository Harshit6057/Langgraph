# pip install -U langchain langchain-community faiss-cpu sentence-transformers pypdf python-dotenv langsmith certifi
...
def setup_pipeline_and_query(
    ...
    vectorstore = load_or_build_index(pdf_path, chunk_size, chunk_overlap, embed_model_name, force_rebuild)
